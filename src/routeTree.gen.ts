...
const StudentCampusIdLevelRoute = StudentCampusIdLevelRouteImport.update({
  id: '/student/$campusId/$level',
  path: '/student/$campusId/$level',
  getParentRoute: () => rootRouteImport,
} as any)
const ProjectorCampusIdLevelRoute = ProjectorCampusIdLevelRouteImport.update({
  id: '/projector/$campusId/$level',
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/student/$campusId/$level': {
      id: '/student/$campusId/$level'
      path: '/student/$campusId/$level'
      fullPath: '/student/$campusId/$level'
      preLoaderRoute: typeof StudentCampusIdLevelRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/projector/$campusId/$level': {
      id: '/projector/$campusId/$level'
      path: '/projector/$campusId/$level'
      fullPath: '/projector/$campusId/$level'
